...
public class PoggMainLayer extends LayerRenderer<PoggEntity, PoggModel<PoggEntity>> {
	protected static final ResourceLocation MAINTEXTURE = new ResourceLocation(PoggMod.MOD_ID,
			"textures/entities/pogg_entity_main.png");

	public PoggMainLayer(IEntityRenderer<PoggEntity, PoggModel<PoggEntity>> p_i50914_1_) {
		super(p_i50914_1_);
	}
